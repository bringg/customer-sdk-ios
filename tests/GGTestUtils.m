...
#define ALPHA_NUMERIC_CHARSET @"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"
...
+(nonnull NSString *)randomStringWithLength:(NSUInteger)length{
    ...
    for (int i=0; i<length; i++) {
        [randomString appendFormat: @"%C", [ALPHA_NUMERIC_CHARSET characterAtIndex: arc4random_uniform((int)[ALPHA_NUMERIC_CHARSET length])]];
    }
